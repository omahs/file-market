...
import "./FilemarketCollectionV2.sol";

contract Mark3dAccessTokenV2 is IAccessToken, ERC721Enumerable, AccessControl, Ownable {
    using Clones for address;
    using EnumerableSet for EnumerableSet.Bytes32Set;

    mapping(uint256 => FilemarketCollectionV2) public tokenCollections;  // mapping from access token id to collection
    ...
    constructor(
        ...
        FilemarketCollectionV2 _implementation,
    ...
    function createCollection(
        ...
        FilemarketCollectionV2 instance = new FilemarketCollectionV2{salt: salt}();
        tokenCollections[tokenId] = instance;
        tokenUris[tokenId] = accessTokenMetaUri;
        instance.initialize(name, symbol, _contractMetaUri,
            this, tokenId, _msgSender(), royaltyReceiver, data, fraudDecider, fraudLateDecisionEnabled);
        tokensCount++;

        emit CollectionCreation(tokenId, address(instance));
    }
