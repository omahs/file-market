  ...
  return (
    <FileBunniesModalBody>
      <p>
        ...
        {' '}
        to pay for the network fee during Free Mint or to pay
        for Mint of other rarities.
      </p>
      <p>2. Connect your crypto wallet via Wallet Connect</p>
      <p>3. Create or connect your FileWallet</p>
      <p>
        4. Check if you&quot;re on the White List (if you&quot;re
        on the list, the Free Mint button will be active)
      </p>
      <p>
        5. Click Free Mint or Mint if you want to swap your FIL
        for EFT with higher rarity (the chances of getting any
        rarity are random)
      </p>
      <p>6. Wait for the transaction to appear and then sign it</p>
      <p>
        7. In the popped-up window, wait for the &quot;Show
        my FileBunny&quot; button to appear
      </p>
      <p>
        8. Wait for the automatic transfer of the hidden file
        with gifts on your FileBunny EFT page (after the transfer,
        the file will become available for download)
      </p>
      <p>
        9. Complete the transaction on the EFT page by clicking
        the &quot;Send payment&quot; or &quot;Finalize the deal&quot; button;
      </p>
      <p>
        10. Congratulations! You have become the lucky owner of
        your FileBunny! Download the file and enjoy the content.
        This is the NFT with real value inside!
      </p>
    </FileBunniesModalBody>
  )
}
